...
import com.light.springboot.es.Lol;
import com.light.springboot.es.LolService;
...
public class TestController {
    ...
    public String insertTestC() throws IOException {
        insertTest();
        return "success";
    }

    @GetMapping("/insertTestOne")
    public String insertTestOne22(Lol a) throws IOException {
        insertTestOne(a);
        return "success";
    }

    @GetMapping("/updateTest")
    public String updateTest1() throws IOException {
        updateTest();
        return "success";
    ...
    public String deleteTest3(String id) throws IOException {
        lolService.deleteRequest(INDEX_NAME, id);
        return "success";

    }

    @GetMapping("/searchListTest")
    public List<Lol> searchListTest32() throws IOException {
        return searchListTest();
    }

    @GetMapping("/searchOne")
    public List<Lol> searchListTestOne(String id) {
        return lolService.searchList(INDEX_NAME, id);

    }

    @GetMapping("/deleteIndex")
    public String deleteIndex2() throws IOException {
        deleteIndex();
        return "success";
    ...
    @GetMapping("/ce")
    public String cd() throws InterruptedException {
        for (int i = 0; i < 5; i++) {
            Lol build = Lol.builder().id(Long.valueOf(i)).build();
            insertTestOne(build);
            Thread.sleep(500);
            List<Lol> personList = lolService.searchList(INDEX_NAME, String.valueOf(i));
            System.out.println(personList.size());
            System.out.println(CollectionUtils.isEmpty(personList));
            deleteTest(String.valueOf(i));
        }
        return "success";
    ...
    public void insertTestOne(Lol a) {

        lolService.insertRequest(INDEX_NAME, a.getId().toString(), a);
    }
    ...
    public List<Lol> searchListTest() {
